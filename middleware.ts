...
export const config = {
  matcher: [
    ...
    '/((?!api/telegram|api/mcp|api/integraciones|api/cron|\\.well-known|_next/static|_next/image|favicon.ico|manifest.webmanifest|sw\\.js|offline\\.html|.*\\.(?:svg|png|jpg|jpeg|gif|webp|ico|webmanifest)$).*)',
  ],
}
